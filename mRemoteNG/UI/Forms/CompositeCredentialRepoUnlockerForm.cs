...
namespace mRemoteNG.UI.Forms
{
    public sealed partial class CompositeCredentialRepoUnlockerForm : Form
    {
        ...
        public CompositeCredentialRepoUnlockerForm(CompositeRepositoryUnlocker repositoryUnlocker)
        {
            ...
            ApplyLanguage();
            ApplyTheme();
            chkCloseAfterLastUnlock.Checked = Properties.Settings.Default.CloseCredentialUnlockerDialogAfterLastUnlock;
        ...
        private void buttonUnlock_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Properties.Settings.Default.CloseCredentialUnlockerDialogAfterLastUnlock && _repositoryUnlocker.Repositories.All(r => r.IsLoaded))
                {
                    Close();
                }
            }
        ...
        {
            Properties.Settings.Default.CloseCredentialUnlockerDialogAfterLastUnlock = chkCloseAfterLastUnlock.Checked;
        ...
        private ImageList SetupImageList()
        {
            ...
            imageList.Images.Add(_display.ScaleImage(Properties.Resources.GlyphLeft_16x));
            imageList.Images.SetKeyName(0, "unlocking");
            imageList.Images.Add(_display.ScaleImage(Properties.Resources.Unlock_16x));
            imageList.Images.SetKeyName(1, "unlocked");
            imageList.Images.Add(_display.ScaleImage(Properties.Resources.Lock_16x));
