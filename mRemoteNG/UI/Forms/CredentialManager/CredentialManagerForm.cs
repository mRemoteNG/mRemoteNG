...
namespace mRemoteNG.UI.Forms.CredentialManager
{
    public partial class CredentialManagerForm : Form
    {
        ...
        {
            //TODO: RESX
            //Text = Language.CredentialManager;
            //buttonClose.Text = Language.ButtonClose;
            //msAddRepo.Text = Language.AddRepo;
            //msEditRepo.Text = Language.EditRepo;
            //msRemoveRepo.Text = Language.RemoveRepo;
            //msToggleUnlock.Text = Language.LockRepo;
        }
        ...
        private void SetupListView()
        {
            ...
            _buttonImages.Images.Add("Locked", mRemoteNG.Properties.Resources.Lock_16x);
            _buttonImages.Images.Add("Unlocked", Properties.Resources.Unlock_16x);
            _buttonImages.Images.Add("Edit", Properties.Resources.Edit_16x);
        ...
        private void UpdateUi()
        {
            ...
            if (repoIsSelected)
                msToggleUnlock.Text = selectedRepository.IsLoaded ? Language.RepoLock : Language.RepoUnlock;
        }
