...
namespace mRemoteNG.UI.Window
{
    public class SSHTransferWindow : BaseWindow
    {
        ...
        private void InitializeComponent()
        {
            ...
            grpFiles = new Controls.Base.NGGroupBox();
            lblLocalFile = new Controls.Base.NGLabel();
            txtLocalFile = new Controls.Base.NGTextBox();
            btnTransfer = new Controls.Base.NGButton();
            txtRemoteFile = new Controls.Base.NGTextBox();
            lblRemoteFile = new Controls.Base.NGLabel();
            btnBrowse = new Controls.Base.NGButton();
            grpConnection = new Controls.Base.NGGroupBox();
            radProtSFTP = new Controls.Base.NGRadioButton();
            radProtSCP = new Controls.Base.NGRadioButton();
            lblProtocol = new Controls.Base.NGLabel();
            lblPassword = new Controls.Base.NGLabel();
            lblUser = new Controls.Base.NGLabel();
            lblPort = new Controls.Base.NGLabel();
            lblHost = new Controls.Base.NGLabel();
            txtPort = new Controls.Base.NGTextBox();
            txtHost = new Controls.Base.NGTextBox();
            txtPassword = new Controls.Base.NGTextBox();
            txtUser = new Controls.Base.NGTextBox();
            pbStatus = new Controls.Base.NGProgressBar();
            ...
            // btnTransfer
            // 
            btnTransfer._mice = mRemoteNG.UI.Controls.Base.NGButton.MouseState.HOVER;
            ...
            // btnBrowse
            // 
            btnBrowse._mice = mRemoteNG.UI.Controls.Base.NGButton.MouseState.HOVER;
