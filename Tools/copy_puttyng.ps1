...
Write-Output "Copying Winbox to correct directory"
Copy-Item -Path (Join-Path -Path $SolutionDir -ChildPath "mRemoteV1\Resources\winbox.exe") -Destination $TargetDir -Force
