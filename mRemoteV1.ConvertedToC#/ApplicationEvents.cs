...
namespace mRemoteNG.My
{
	...
	internal partial class MyApplication
	{
		...
		{
			if (mRemoteNG.My.Settings.SingleInstance) {
		...
		private void SwitchToCurrentInstance()
		{
			...
			if (hWnd != IntPtr.Zero) {
				...
				if (mRemoteNG.App.Native.IsIconic(hWnd) != 0) {
					mRemoteNG.App.Native.ShowWindow(hWnd, mRemoteNG.App.Native.SW_RESTORE);
				}

				mRemoteNG.App.Native.SetForegroundWindow(hWnd);
			}
		}
