...
namespace mRemoteNG.App
{
	public class Native
	{
		...
		public static extern bool AppendMenu(IntPtr hMenu, Int32 uFlags, IntPtr uIDNewItem, string lpNewItem);
		...
		#region "Helpers"
		public static Int32 MAKELONG(ref Int32 wLow, ref Int32 wHigh)
		{
			return wLow | wHigh << 16;
		}

		public static Int32 MAKELPARAM(ref Int32 wLow, ref Int32 wHigh)
		{
			return MAKELONG(ref wLow, ref wHigh);
		}

		public static Int32 LOWORD(ref Int32 value)
		{
			return value & 0xffff;
		}

		public static Int32 LOWORD(ref IntPtr value)
		{
			return LOWORD(ref value.ToInt32());
		}

		public static Int32 HIWORD(ref Int32 value)
		{
			return value >> 16;
		}

		public static Int32 HIWORD(ref IntPtr value)
		{
			return HIWORD(ref value.ToInt32());
		}
