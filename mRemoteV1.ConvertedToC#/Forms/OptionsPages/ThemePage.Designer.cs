...
namespace mRemoteNG.Forms.OptionsPages
{
	...
	partial class ThemePage : OptionsPage
	{
		...
		private void InitializeComponent()
		{
			...
			//ThemePropertyGrid
			//
			this.ThemePropertyGrid.Anchor = (System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right);
		...
		private System.Windows.Forms.Button withEventsField_btnThemeDelete;
		internal System.Windows.Forms.Button btnThemeDelete {
			get { return withEventsField_btnThemeDelete; }
			set {
				if (withEventsField_btnThemeDelete != null) {
					withEventsField_btnThemeDelete.Click -= btnThemeDelete_Click;
				}
				withEventsField_btnThemeDelete = value;
				if (withEventsField_btnThemeDelete != null) {
					withEventsField_btnThemeDelete.Click += btnThemeDelete_Click;
				}
			}
		}
		private System.Windows.Forms.Button withEventsField_btnThemeNew;
		internal System.Windows.Forms.Button btnThemeNew {
			get { return withEventsField_btnThemeNew; }
			set {
				if (withEventsField_btnThemeNew != null) {
					withEventsField_btnThemeNew.Click -= btnThemeNew_Click;
				}
				withEventsField_btnThemeNew = value;
				if (withEventsField_btnThemeNew != null) {
					withEventsField_btnThemeNew.Click += btnThemeNew_Click;
				}
			}
		}
		private System.Windows.Forms.ComboBox withEventsField_cboTheme;
		internal System.Windows.Forms.ComboBox cboTheme {
			get { return withEventsField_cboTheme; }
			set {
				if (withEventsField_cboTheme != null) {
					withEventsField_cboTheme.DropDown -= cboTheme_DropDown;
					withEventsField_cboTheme.SelectionChangeCommitted -= cboTheme_SelectionChangeCommitted;
				}
				withEventsField_cboTheme = value;
				if (withEventsField_cboTheme != null) {
					withEventsField_cboTheme.DropDown += cboTheme_DropDown;
					withEventsField_cboTheme.SelectionChangeCommitted += cboTheme_SelectionChangeCommitted;
				}
