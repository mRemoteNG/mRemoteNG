...
namespace mRemoteNG.Forms.OptionsPages
{
	...
	partial class ConnectionsPage : OptionsPage
	{
		...
		private System.Windows.Forms.RadioButton withEventsField_radCredentialsCustom;
		internal System.Windows.Forms.RadioButton radCredentialsCustom {
			get { return withEventsField_radCredentialsCustom; }
			set {
				if (withEventsField_radCredentialsCustom != null) {
					withEventsField_radCredentialsCustom.CheckedChanged -= radCredentialsCustom_CheckedChanged;
				}
				withEventsField_radCredentialsCustom = value;
				if (withEventsField_radCredentialsCustom != null) {
					withEventsField_radCredentialsCustom.CheckedChanged += radCredentialsCustom_CheckedChanged;
				}
			}
