...
namespace mRemoteNG.Forms.OptionsPages
{
	...
	partial class SqlServerPage : OptionsPage
	{
		...
		private void InitializeComponent()
		{
			...
			//lblExperimental
			//
			this.lblExperimental.Anchor = (System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right);
			...
			this.lblExperimental.ForeColor = System.Drawing.Color.FromArgb(Convert.ToInt32(Convert.ToByte(192)), Convert.ToInt32(Convert.ToByte(0)), Convert.ToInt32(Convert.ToByte(0)));
			...
			//lblSQLInfo
			//
			this.lblSQLInfo.Anchor = (System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right);
			...
			this.lblSQLInfo.ForeColor = System.Drawing.Color.FromArgb(Convert.ToInt32(Convert.ToByte(192)), Convert.ToInt32(Convert.ToByte(0)), Convert.ToInt32(Convert.ToByte(0)));
		...
		private System.Windows.Forms.CheckBox withEventsField_chkUseSQLServer;
		internal System.Windows.Forms.CheckBox chkUseSQLServer {
			get { return withEventsField_chkUseSQLServer; }
			set {
				if (withEventsField_chkUseSQLServer != null) {
					withEventsField_chkUseSQLServer.CheckedChanged -= chkUseSQLServer_CheckedChanged;
				}
				withEventsField_chkUseSQLServer = value;
				if (withEventsField_chkUseSQLServer != null) {
					withEventsField_chkUseSQLServer.CheckedChanged += chkUseSQLServer_CheckedChanged;
				}
			}
