...
namespace mRemoteNG.Forms.OptionsPages
{
	...
	public partial class TabsPanelsPage : OptionsPage
	{
		...
		private System.Windows.Forms.CheckBox withEventsField_chkUseOnlyErrorsAndInfosPanel;
		internal System.Windows.Forms.CheckBox chkUseOnlyErrorsAndInfosPanel {
			get { return withEventsField_chkUseOnlyErrorsAndInfosPanel; }
			set {
				if (withEventsField_chkUseOnlyErrorsAndInfosPanel != null) {
					withEventsField_chkUseOnlyErrorsAndInfosPanel.CheckedChanged -= chkUseOnlyErrorsAndInfosPanel_CheckedChanged;
				}
				withEventsField_chkUseOnlyErrorsAndInfosPanel = value;
				if (withEventsField_chkUseOnlyErrorsAndInfosPanel != null) {
					withEventsField_chkUseOnlyErrorsAndInfosPanel.CheckedChanged += chkUseOnlyErrorsAndInfosPanel_CheckedChanged;
				}
			}
