...
namespace mRemoteNG.Forms.OptionsPages
{
	...
	partial class AdvancedPage : OptionsPage
	{
		...
		private void InitializeComponent()
		{
			...
			//btnLaunchPutty
			//
			this.btnLaunchPutty.Image = global::mRemoteNG.My.Resources.Resources.PuttyConfig;
		...
		private System.Windows.Forms.Button withEventsField_btnBrowseXulRunnerPath;
		internal System.Windows.Forms.Button btnBrowseXulRunnerPath {
			get { return withEventsField_btnBrowseXulRunnerPath; }
			set {
				if (withEventsField_btnBrowseXulRunnerPath != null) {
					withEventsField_btnBrowseXulRunnerPath.Click -= btnBrowseXulRunnerPath_Click;
				}
				withEventsField_btnBrowseXulRunnerPath = value;
				if (withEventsField_btnBrowseXulRunnerPath != null) {
					withEventsField_btnBrowseXulRunnerPath.Click += btnBrowseXulRunnerPath_Click;
				}
			}
		...
		private System.Windows.Forms.CheckBox withEventsField_chkUseCustomPuttyPath;
		internal System.Windows.Forms.CheckBox chkUseCustomPuttyPath {
			get { return withEventsField_chkUseCustomPuttyPath; }
			set {
				if (withEventsField_chkUseCustomPuttyPath != null) {
					withEventsField_chkUseCustomPuttyPath.CheckedChanged -= chkUseCustomPuttyPath_CheckedChanged;
				}
				withEventsField_chkUseCustomPuttyPath = value;
				if (withEventsField_chkUseCustomPuttyPath != null) {
					withEventsField_chkUseCustomPuttyPath.CheckedChanged += chkUseCustomPuttyPath_CheckedChanged;
				}
			}
		...
		private System.Windows.Forms.TextBox withEventsField_txtCustomPuttyPath;
		internal System.Windows.Forms.TextBox txtCustomPuttyPath {
			get { return withEventsField_txtCustomPuttyPath; }
			set {
				if (withEventsField_txtCustomPuttyPath != null) {
					withEventsField_txtCustomPuttyPath.TextChanged -= txtCustomPuttyPath_TextChanged;
				}
				withEventsField_txtCustomPuttyPath = value;
				if (withEventsField_txtCustomPuttyPath != null) {
					withEventsField_txtCustomPuttyPath.TextChanged += txtCustomPuttyPath_TextChanged;
				}
			}
		}
		private System.Windows.Forms.Button withEventsField_btnLaunchPutty;
		internal System.Windows.Forms.Button btnLaunchPutty {
			get { return withEventsField_btnLaunchPutty; }
			set {
				if (withEventsField_btnLaunchPutty != null) {
					withEventsField_btnLaunchPutty.Click -= btnLaunchPutty_Click;
				}
				withEventsField_btnLaunchPutty = value;
				if (withEventsField_btnLaunchPutty != null) {
					withEventsField_btnLaunchPutty.Click += btnLaunchPutty_Click;
				}
			}
		...
		private System.Windows.Forms.Button withEventsField_btnBrowseCustomPuttyPath;
		internal System.Windows.Forms.Button btnBrowseCustomPuttyPath {
			get { return withEventsField_btnBrowseCustomPuttyPath; }
			set {
				if (withEventsField_btnBrowseCustomPuttyPath != null) {
					withEventsField_btnBrowseCustomPuttyPath.Click -= btnBrowseCustomPuttyPath_Click;
				}
				withEventsField_btnBrowseCustomPuttyPath = value;
				if (withEventsField_btnBrowseCustomPuttyPath != null) {
					withEventsField_btnBrowseCustomPuttyPath.Click += btnBrowseCustomPuttyPath_Click;
				}
			}
