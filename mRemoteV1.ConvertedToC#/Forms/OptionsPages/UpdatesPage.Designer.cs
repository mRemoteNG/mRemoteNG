...
namespace mRemoteNG.Forms.OptionsPages
{
	...
	partial class UpdatesPage : OptionsPage
	{
		...
		private void InitializeComponent()
		{
			...
			this.lblUpdatesExplanation.Text = "mRemoteNG can periodically connect to the mRemoteNG website to check for updates " + "and product announcements.";
			//
			//pnlUpdateCheck
			//
		...
		private System.Windows.Forms.Button withEventsField_btnUpdateCheckNow;
		internal System.Windows.Forms.Button btnUpdateCheckNow {
			get { return withEventsField_btnUpdateCheckNow; }
			set {
				if (withEventsField_btnUpdateCheckNow != null) {
					withEventsField_btnUpdateCheckNow.Click -= btnUpdateCheckNow_Click;
				}
				withEventsField_btnUpdateCheckNow = value;
				if (withEventsField_btnUpdateCheckNow != null) {
					withEventsField_btnUpdateCheckNow.Click += btnUpdateCheckNow_Click;
				}
			}
		}
		private System.Windows.Forms.CheckBox withEventsField_chkCheckForUpdatesOnStartup;
		internal System.Windows.Forms.CheckBox chkCheckForUpdatesOnStartup {
			get { return withEventsField_chkCheckForUpdatesOnStartup; }
			set {
				if (withEventsField_chkCheckForUpdatesOnStartup != null) {
					withEventsField_chkCheckForUpdatesOnStartup.CheckedChanged -= chkCheckForUpdatesOnStartup_CheckedChanged;
				}
				withEventsField_chkCheckForUpdatesOnStartup = value;
				if (withEventsField_chkCheckForUpdatesOnStartup != null) {
					withEventsField_chkCheckForUpdatesOnStartup.CheckedChanged += chkCheckForUpdatesOnStartup_CheckedChanged;
				}
			}
		...
		private System.Windows.Forms.CheckBox withEventsField_chkUseProxyForAutomaticUpdates;
		internal System.Windows.Forms.CheckBox chkUseProxyForAutomaticUpdates {
			get { return withEventsField_chkUseProxyForAutomaticUpdates; }
			set {
				if (withEventsField_chkUseProxyForAutomaticUpdates != null) {
					withEventsField_chkUseProxyForAutomaticUpdates.CheckedChanged -= chkUseProxyForAutomaticUpdates_CheckedChanged;
				}
				withEventsField_chkUseProxyForAutomaticUpdates = value;
				if (withEventsField_chkUseProxyForAutomaticUpdates != null) {
					withEventsField_chkUseProxyForAutomaticUpdates.CheckedChanged += chkUseProxyForAutomaticUpdates_CheckedChanged;
				}
			}
		}
		private System.Windows.Forms.CheckBox withEventsField_chkUseProxyAuthentication;
		internal System.Windows.Forms.CheckBox chkUseProxyAuthentication {
			get { return withEventsField_chkUseProxyAuthentication; }
			set {
				if (withEventsField_chkUseProxyAuthentication != null) {
					withEventsField_chkUseProxyAuthentication.CheckedChanged -= chkUseProxyAuthentication_CheckedChanged;
				}
				withEventsField_chkUseProxyAuthentication = value;
				if (withEventsField_chkUseProxyAuthentication != null) {
					withEventsField_chkUseProxyAuthentication.CheckedChanged += chkUseProxyAuthentication_CheckedChanged;
				}
			}
		...
		private System.Windows.Forms.Button withEventsField_btnTestProxy;
		internal System.Windows.Forms.Button btnTestProxy {
			get { return withEventsField_btnTestProxy; }
			set {
				if (withEventsField_btnTestProxy != null) {
					withEventsField_btnTestProxy.Click -= btnTestProxy_Click;
				}
				withEventsField_btnTestProxy = value;
				if (withEventsField_btnTestProxy != null) {
					withEventsField_btnTestProxy.Click += btnTestProxy_Click;
				}
			}
