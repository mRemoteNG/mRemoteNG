...
namespace mRemoteNG.UI
{
	namespace Window
	{
		public class About : UI.Window.Base
		{
			...
			private System.Windows.Forms.LinkLabel withEventsField_llblFAMFAMFAM;
			internal System.Windows.Forms.LinkLabel llblFAMFAMFAM {
				get { return withEventsField_llblFAMFAMFAM; }
				set {
					if (withEventsField_llblFAMFAMFAM != null) {
						withEventsField_llblFAMFAMFAM.LinkClicked -= llblFAMFAMFAM_LinkClicked;
					}
					withEventsField_llblFAMFAMFAM = value;
					if (withEventsField_llblFAMFAMFAM != null) {
						withEventsField_llblFAMFAMFAM.LinkClicked += llblFAMFAMFAM_LinkClicked;
					}
				}
			}
			private System.Windows.Forms.LinkLabel withEventsField_llblMagicLibrary;
			internal System.Windows.Forms.LinkLabel llblMagicLibrary {
				get { return withEventsField_llblMagicLibrary; }
				set {
					if (withEventsField_llblMagicLibrary != null) {
						withEventsField_llblMagicLibrary.LinkClicked -= llblMagicLibrary_LinkClicked;
					}
					withEventsField_llblMagicLibrary = value;
					if (withEventsField_llblMagicLibrary != null) {
						withEventsField_llblMagicLibrary.LinkClicked += llblMagicLibrary_LinkClicked;
					}
				}
			}
			private System.Windows.Forms.LinkLabel withEventsField_llblWeifenLuo;
			internal System.Windows.Forms.LinkLabel llblWeifenLuo {
				get { return withEventsField_llblWeifenLuo; }
				set {
					if (withEventsField_llblWeifenLuo != null) {
						withEventsField_llblWeifenLuo.LinkClicked -= llblWeifenLuo_LinkClicked;
					}
					withEventsField_llblWeifenLuo = value;
					if (withEventsField_llblWeifenLuo != null) {
						withEventsField_llblWeifenLuo.LinkClicked += llblWeifenLuo_LinkClicked;
					}
				}
			...
			private void InitializeComponent()
			{
				...
				this.lblEdition.Font = new System.Drawing.Font("Microsoft Sans Serif", 14.25f, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, Convert.ToByte(0));
				...
				//pbLogo
				//
				this.pbLogo.Image = global::mRemoteNG.My.Resources.Resources.Logo;
				...
				this.llblWeifenLuo.Font = new System.Drawing.Font("Microsoft Sans Serif", 11f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, Convert.ToByte(0));
				...
				this.llblMagicLibrary.Font = new System.Drawing.Font("Microsoft Sans Serif", 11f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, Convert.ToByte(0));
				...
				this.llblFAMFAMFAM.Font = new System.Drawing.Font("Microsoft Sans Serif", 11f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, Convert.ToByte(0));
				...
				//txtChangeLog
				//
				this.txtChangeLog.Anchor = (System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right);
				...
				this.txtChangeLog.Font = new System.Drawing.Font("Microsoft Sans Serif", 9f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, Convert.ToByte(0));
				...
				this.lblTitle.Font = new System.Drawing.Font("Microsoft Sans Serif", 14f, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, Convert.ToByte(0));
				...
				this.lblVersion.Font = new System.Drawing.Font("Microsoft Sans Serif", 11f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, Convert.ToByte(0));
				...
				this.lblChangeLog.Font = new System.Drawing.Font("Microsoft Sans Serif", 11f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, Convert.ToByte(0));
				...
				this.lblLicense.Font = new System.Drawing.Font("Microsoft Sans Serif", 11f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, Convert.ToByte(0));
				...
				this.lblCopyright.Font = new System.Drawing.Font("Microsoft Sans Serif", 11f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, Convert.ToByte(0));
			...
			{
				lblLicense.Text = mRemoteNG.My.Language.strLabelReleasedUnderGPL;
				lblChangeLog.Text = mRemoteNG.My.Language.strLabelChangeLog;
				TabText = mRemoteNG.My.Language.strAbout;
				Text = mRemoteNG.My.Language.strAbout;
			}

			#if PORTABLE
			private void ApplyEditions()
			{
				lblEdition.Text = mRemoteNG.My.Language.strLabelPortableEdition;
			...
			private void About_Load(object sender, System.EventArgs e)
			{
				...
				try {
					lblCopyright.Text = mRemoteNG.My.MyProject.Application.Info.Copyright;

					this.lblVersion.Text = "Version " + mRemoteNG.My.MyProject.Application.Info.Version.ToString();

					FillLinkLabel(llblFAMFAMFAM, mRemoteNG.My.Language.strFAMFAMFAMAttribution, mRemoteNG.My.Language.strFAMFAMFAMAttributionURL);
					FillLinkLabel(llblMagicLibrary, mRemoteNG.My.Language.strMagicLibraryAttribution, mRemoteNG.My.Language.strMagicLibraryAttributionURL);
					FillLinkLabel(llblWeifenLuo, mRemoteNG.My.Language.strWeifenLuoAttribution, mRemoteNG.My.Language.strWeifenLuoAttributionURL);

					if (File.Exists(mRemoteNG.My.MyProject.Application.Info.DirectoryPath + "\\CHANGELOG.TXT")) {
						StreamReader sR = new StreamReader(mRemoteNG.My.MyProject.Application.Info.DirectoryPath + "\\CHANGELOG.TXT");
						this.txtChangeLog.Text = sR.ReadToEnd();
						sR.Close();
					}
				} catch (Exception ex) {
					mRemoteNG.App.Runtime.MessageCollector.AddMessage(mRemoteNG.Messages.MessageClass.ErrorMsg, "Loading About failed" + Constants.vbNewLine + ex.Message, true);
				}
			}

			private void llblFAMFAMFAM_LinkClicked(System.Object sender, System.Windows.Forms.LinkLabelLinkClickedEventArgs e)
			{
				mRemoteNG.App.Runtime.GoToURL(mRemoteNG.My.Language.strFAMFAMFAMAttributionURL);
			}

			private void llblMagicLibrary_LinkClicked(System.Object sender, System.Windows.Forms.LinkLabelLinkClickedEventArgs e)
			{
				mRemoteNG.App.Runtime.GoToURL(mRemoteNG.My.Language.strMagicLibraryAttributionURL);
			}

			private void llblWeifenLuo_LinkClicked(System.Object sender, System.Windows.Forms.LinkLabelLinkClickedEventArgs e)
			{
				mRemoteNG.App.Runtime.GoToURL(mRemoteNG.My.Language.strWeifenLuoAttributionURL);
			}
			#endregion
		}
	}
