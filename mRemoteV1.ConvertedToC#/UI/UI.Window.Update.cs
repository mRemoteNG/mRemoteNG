...
namespace mRemoteNG.UI
{
	namespace Window
	{
		public partial class Update : Base
		{
			...
			private void btnCheckForUpdate_Click(System.Object sender, EventArgs e)
			{
				CheckForUpdate();
			}

			private void btnDownload_Click(System.Object sender, EventArgs e)
			{
				DownloadUpdate();
			}

			private void pbUpdateImage_Click(System.Object sender, EventArgs e)
			{
			...
			private void GetUpdateInfoCompleted(object sender, AsyncCompletedEventArgs e)
			{
				...
				try {
					...
					mRemoteNG.App.Runtime.MessageCollector.AddExceptionMessage(Language.strUpdateCheckCompleteFailed, ex);
				}
			}
			...
			private void GetChangeLogCompleted(object sender, System.ComponentModel.AsyncCompletedEventArgs e)
			{
				...
				try {
					...
					mRemoteNG.App.Runtime.MessageCollector.AddExceptionMessage(Language.strUpdateGetChangeLogFailed, ex);
				}
			}
			...
			private void DownloadUpdate()
			{
				try {
					...
					mRemoteNG.App.Runtime.MessageCollector.AddExceptionMessage(Language.strUpdateDownloadFailed, ex);
				}
			}
			#endregion
			...
			private void DownloadUpdateCompleted(object sender, System.ComponentModel.AsyncCompletedEventArgs e)
			{
				try {
					...
					mRemoteNG.App.Runtime.MessageCollector.AddExceptionMessage(Language.strUpdateDownloadCompleteFailed, ex);
				}
			}
			#endregion
		}
