...
namespace mRemoteNG.UI
{
	namespace Window
	{
		public class Help : UI.Window.Base
		{

			#region "Form Init"
			private System.Windows.Forms.TreeView withEventsField_tvIndex;
			internal System.Windows.Forms.TreeView tvIndex {
				get { return withEventsField_tvIndex; }
				set {
					if (withEventsField_tvIndex != null) {
						withEventsField_tvIndex.NodeMouseClick -= tvIndex_NodeMouseClick;
						withEventsField_tvIndex.AfterSelect -= tvIndex_AfterSelect;
					}
					withEventsField_tvIndex = value;
					if (withEventsField_tvIndex != null) {
						withEventsField_tvIndex.NodeMouseClick += tvIndex_NodeMouseClick;
						withEventsField_tvIndex.AfterSelect += tvIndex_AfterSelect;
					}
			...
			private System.Windows.Forms.WebBrowser withEventsField_wbHelp;
			internal System.Windows.Forms.WebBrowser wbHelp {
				get { return withEventsField_wbHelp; }
				set {
					if (withEventsField_wbHelp != null) {
						withEventsField_wbHelp.DocumentTitleChanged -= wbHelp_DocumentTitleChanged;
					}
					withEventsField_wbHelp = value;
					if (withEventsField_wbHelp != null) {
						withEventsField_wbHelp.DocumentTitleChanged += wbHelp_DocumentTitleChanged;
					}
				}
			...
			private void InitializeComponent()
			{
				...
				System.Windows.Forms.TreeNode TreeNode7 = new System.Windows.Forms.TreeNode("Getting Started", new System.Windows.Forms.TreeNode[] {
					TreeNode2,
					TreeNode3,
					TreeNode4,
					TreeNode5,
				...
				System.Windows.Forms.TreeNode TreeNode23 = new System.Windows.Forms.TreeNode("User Interface", new System.Windows.Forms.TreeNode[] {
					TreeNode8,
					TreeNode9,
					TreeNode10,
					TreeNode11,
				...
				System.Windows.Forms.TreeNode TreeNode25 = new System.Windows.Forms.TreeNode("Help", new System.Windows.Forms.TreeNode[] {
					TreeNode1,
					TreeNode7,
					TreeNode23,
					TreeNode24
				...
				//wbHelp
				//
				this.wbHelp.Anchor = (System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right);
				...
				//tvIndex
				//
				this.tvIndex.Anchor = (System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right);
				...
				//pnlSplitter
				//
				this.pnlSplitter.Anchor = (System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right);
				...
				//lblDocName
				//
				this.lblDocName.Anchor = (System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) | System.Windows.Forms.AnchorStyles.Right);
				this.lblDocName.BackColor = System.Drawing.Color.DimGray;
				this.lblDocName.Font = new System.Drawing.Font("Microsoft Sans Serif", 12f, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, Convert.ToByte(0));
				...
				this.Icon = global::mRemoteNG.My.Resources.Resources.Help_Icon;
				this.Name = "Help";
				this.TabText = "Help";
				this.Text = "Help";
			...
			{
				if (!string.IsNullOrEmpty(e.Node.Tag)) {
					this.wbHelp.Navigate(mRemoteNG.My.MyProject.Application.Info.DirectoryPath + "\\Help\\" + e.Node.Tag + ".htm");
				}
			}
			...
			{
				this.imgListHelp.Images.Add("File", mRemoteNG.My.Resources.Page);
				this.imgListHelp.Images.Add("Folder", mRemoteNG.My.Resources.Folder);
				this.imgListHelp.Images.Add("Help", mRemoteNG.My.Resources.Help);
			}
