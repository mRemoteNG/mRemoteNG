...
namespace mRemoteNGTests.UI.Controls.SCP
{
    ...
    public class RemoteFileBrowserPanelTests
    {
        private RemoteFileBrowserPanel _panel;
        ...
        public void Setup()
        {
            ...
            // Create the panel
            _panel = new RemoteFileBrowserPanel
            {
                Dock = DockStyle.Fill
            };
        ...
        public void EscapePressed_EventExists()
        {
            ...
            var eventInfo = typeof(RemoteFileBrowserPanel).GetEvent("EscapePressed");

            // Assert
            Assert.That(eventInfo, Is.Not.Null,
                "RemoteFileBrowserPanel should have an EscapePressed event");
        ...
        public void EscapePressed_EventCanBeSubscribed()
        {
            ...
            var eventField = typeof(RemoteFileBrowserPanel)
        ...
        public void ProcessCmdKey_MethodExists()
        {
            ...
            var method = typeof(RemoteFileBrowserPanel).GetMethod("ProcessCmdKey",
                System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);

            // Assert
            Assert.That(method, Is.Not.Null,
                "RemoteFileBrowserPanel should override ProcessCmdKey");
        }
        ...
        {
            // Assert
            Assert.That(_panel.IsConnected, Is.False,
                "IsConnected should be false before initialization");
        }
        ...
        {
            // Arrange & Act
            RemoteFileBrowserPanel panel = null;

            // Assert
            Assert.DoesNotThrow(() => panel = new RemoteFileBrowserPanel(),
        ...
        public void Panel_CanBeAddedToForm()
        {
            // Arrange
            var form = new Form();
            var panel = new RemoteFileBrowserPanel { Dock = DockStyle.Fill };
        ...
        {
            // Act & Assert
            Assert.DoesNotThrow(() => _panel.Disconnect(),
