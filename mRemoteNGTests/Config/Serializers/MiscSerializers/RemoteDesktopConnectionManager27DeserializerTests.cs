    ...
    public class RemoteDesktopConnectionManager27DeserializerTests
    {
        ...
        private static IEnumerable<TestCaseData> ExpectedPropertyValues()
        {
            return new[]
            {
                ...
                new TestCaseData((Func<ConnectionInfo, object>) (con => con.UseConsoleSession),
                    ExpectedUseConsoleSession).SetName(nameof(ConnectionInfo.UseConsoleSession)),
                ...
                new TestCaseData((Func<ConnectionInfo, object>) (con => con.RDGatewayDomain), ExpectedGatewayDomain)
                    .SetName(nameof(ConnectionInfo.RDGatewayDomain)),
                ...
                new TestCaseData((Func<ConnectionInfo, object>) (con => con.RedirectKeys), ExpectedKeyRedirection)
                    .SetName(nameof(ConnectionInfo.RedirectKeys)),
                ...
                new TestCaseData((Func<ConnectionInfo, object>) (con => con.RedirectPrinters),
                    ExpectedPrinterRedirection).SetName(nameof(ConnectionInfo.RedirectPrinters)),
                new TestCaseData((Func<ConnectionInfo, object>) (con => con.RedirectPorts), ExpectedPortRedirection)
                    .SetName(nameof(ConnectionInfo.RedirectPorts)),
                new TestCaseData((Func<ConnectionInfo, object>) (con => con.RedirectDiskDrives),
                    ExpectedDriveRedirection).SetName(nameof(ConnectionInfo.RedirectDiskDrives))
            };
        }
        ...
        private static IEnumerable<TestCaseData> NullPropertyValues()
        {
            return new[]
            {
                ...
                new TestCaseData((Func<ConnectionInfo, object>) (con => con.Username)).SetName(
                    nameof(ConnectionInfo.Username)),
                new TestCaseData((Func<ConnectionInfo, object>) (con => con.Domain)).SetName(
                    nameof(ConnectionInfo.Domain)),
                ...
                new TestCaseData((Func<ConnectionInfo, object>) (con => con.Resolution)).SetName(
                    nameof(ConnectionInfo.Resolution)),
                new TestCaseData((Func<ConnectionInfo, object>) (con => con.Colors)).SetName(
                    nameof(ConnectionInfo.Colors)),
