    ...
    public class ConfigWindow : BaseWindow
    {
        ...
        private void InitializeComponent()
        {
            ...
            propertyGridContextMenu.Items.AddRange(new ToolStripItem[]
                {propertyGridContextMenuReset, ToolStripSeparator1, propertyGridContextMenuShowHelpText});
        ...
        {
            get { return btnShowInheritance.Checked; }
            set
            {
        ...
        {
            get { return btnShowDefaultProperties.Checked; }
            set
            {
        ...
        public void SetPropertyGridObject(object Obj)
        {
            try
            {
                ...
                {
                    if (Obj is ContainerInfo) //CONTAINER
                    {
                        if (Obj is RootNodeInfo) // ROOT
                        {
                ...
                else if (Obj is ConnectionInfoInheritance) //INHERITANCE
                {
                    ...
                    if (InheritanceVisible)
                    {
                        ...
                        InheritanceVisible = true;
                        var conIcon =
                            ConnectionIcon.FromString(
                                Convert.ToString(((ConnectionInfo) ((ConnectionInfoInheritance) Obj).Parent).Icon));
                        if (conIcon != null)
                            btnIcon.Image = conIcon.ToBitmap();
                    }
            ...
            catch (Exception ex)
            {
                Runtime.MessageCollector.AddMessage(MessageClass.ErrorMsg,
                    Language.strConfigPropertyGridObjectFailed + Environment.NewLine + ex.Message, true);
            }
        }
        ...
        {
            pGrid.BackColor = ThemeManager.ActiveTheme.ToolbarBackgroundColor;
            pGrid.ForeColor = ThemeManager.ActiveTheme.ToolbarTextColor;
            pGrid.ViewBackColor = ThemeManager.ActiveTheme.ConfigPanelBackgroundColor;
            pGrid.ViewForeColor = ThemeManager.ActiveTheme.ConfigPanelTextColor;
            pGrid.LineColor = ThemeManager.ActiveTheme.ConfigPanelGridLineColor;
            pGrid.HelpBackColor = ThemeManager.ActiveTheme.ConfigPanelHelpBackgroundColor;
            pGrid.HelpForeColor = ThemeManager.ActiveTheme.ConfigPanelHelpTextColor;
            pGrid.CategoryForeColor = ThemeManager.ActiveTheme.ConfigPanelCategoryTextColor;
        }
        ...
        private void AddToolStripItems()
        {
            ...
            {
                Runtime.MessageCollector.AddMessage(MessageClass.ErrorMsg,
                    Language.strConfigUiLoadFailed + Environment.NewLine + ex.Message, true);
            }
        }
        ...
        private void pGrid_PropertyValueChanged(object s, PropertyValueChangedEventArgs e)
        {
            ...
            {
                Runtime.MessageCollector.AddMessage(MessageClass.ErrorMsg,
                    Language.strConfigPropertyGridValueFailed + Environment.NewLine + ex.Message, true);
            }
        }
        ...
        private void ShowHideGridItems()
        {
                        ...
                        case ProtocolType.RDP:
                            ...
                            if (conI.RDGatewayUsageMethod == ProtocolRDP.RDGatewayUsageMethod.Never)
                            {
                                ...
                                strHide.Add("RDGatewayUsername");
                                     ...
                                     ProtocolRDP.RDGatewayUseConnectionCredentials.Yes)
                            {
                                strHide.Add("RDGatewayDomain");
                                strHide.Add("RDGatewayPassword");
                                strHide.Add("RDGatewayUsername");
                            ...
                            if (
                                !((conI.Resolution == ProtocolRDP.RDPResolutions.FitToWindow) ||
                                  (conI.Resolution == ProtocolRDP.RDPResolutions.Fullscreen)))
                                strHide.Add("AutomaticResize");
                            break;
            ...
            {
                Runtime.MessageCollector.AddMessage(MessageClass.ErrorMsg,
                    Language.strConfigPropertyGridHideItemsFailed + Environment.NewLine + ex.Message, true);
            }
        }
        ...
        private void btnIcon_Click(object sender, MouseEventArgs e)
        {
            try
            {
                if (pGrid.SelectedObject is ConnectionInfo && !(pGrid.SelectedObject is PuttySessionInfo))
                {
                    ...
                    var mPos =
                        new Point(new Size(PointToScreen(new Point(e.Location.X + pGrid.Width - 100, e.Location.Y))));
                    cMenIcons.Show(mPos);
                }
            }
            catch (Exception ex)
            {
                Runtime.MessageCollector.AddMessage(MessageClass.ErrorMsg,
                    Language.strConfigPropertyGridButtonIconClickFailed + Environment.NewLine + ex.Message, true);
            }
        }
        ...
        private void IconMenu_Click(object sender, EventArgs e)
        {
            ...
            {
                Runtime.MessageCollector.AddMessage(MessageClass.ErrorMsg,
                    Language.strConfigPropertyGridMenuClickFailed + Environment.NewLine + ex.Message, true);
            }
        }
        ...
        public void SetHostStatus(object connectionInfo)
        {
            ...
            {
                Runtime.MessageCollector.AddMessage(MessageClass.ErrorMsg,
                    Language.strConfigPropertyGridSetHostStatusFailed + Environment.NewLine + ex.Message, true);
            }
        }
        ...
        private void propertyGridContextMenu_Opening(object sender, CancelEventArgs e)
        {
            try
            {
                ...
                propertyGridContextMenuReset.Enabled =
                    Convert.ToBoolean((pGrid.SelectedObject != null) && (gridItem?.PropertyDescriptor != null) &&
        ...
        private void propertyGridContextMenuReset_Click(object sender, EventArgs e)
        {
            ...
            {
                var gridItem = pGrid.SelectedGridItem;
                if ((pGrid.SelectedObject != null) && (gridItem?.PropertyDescriptor != null) &&
                    gridItem.PropertyDescriptor.CanResetValue(pGrid.SelectedObject))
