...
namespace mRemoteNG.UI.Controls
{
    public static class TextBoxExtensions
    {
        public static bool SetCueBannerText(this TextBox textBox, string cueText, bool showCueWhenFocused = false)
        {
            ...
            var result = NativeMethods.SendMessage(textBox.Handle, NativeMethods.EM_SETCUEBANNER, (IntPtr) Convert.ToInt32(showCueWhenFocused), cueText);
        ...
        public static string GetCueBannerText(this TextBox textBox)
        {
            ...
            var result = NativeMethods.SendMessage(textBox.Handle, NativeMethods.EM_GETCUEBANNER, cueBannerText, new IntPtr(cueBannerText.Capacity));
