...
namespace mRemoteNG.UI.Controls.FilteredPropertyGrid
{
    ...
    public partial class FilteredPropertyGrid : PropertyGrid
    {
        ...
        private readonly List<PropertyDescriptor> m_PropertyDescriptors = new List<PropertyDescriptor>();
        ...
        private void RefreshProperties()
        {
            ...
            else
            {
                ...
                if (m_HiddenAttributes != null)
                    foreach (Attribute attribute in m_HiddenAttributes) HideAttribute(attribute);
            }
        ...
        {
            var filteredoriginalpropertydescriptors = TypeDescriptor.GetProperties(m_Wrapper.SelectedObject,
                new[] {attribute});
