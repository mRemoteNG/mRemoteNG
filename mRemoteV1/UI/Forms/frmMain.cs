...
namespace mRemoteNG.UI.Forms
{
    public partial class frmMain
    {
        ...
        private void tsExtAppEntry_Click(object sender, EventArgs e)
        {
            ...
            if ((selectedTreeNode.GetTreeNodeType() == TreeNodeType.Connection) |
        ...
        private void mMenReconnectAll_Click(object sender, EventArgs e)
        {
            ...
            foreach (BaseWindow window in Runtime.WindowList)
            {
                ...
                foreach (TabPage tab in connectionWindow.TabController.TabPages)
                {
                            ...
                            else
                            {
                                    ...
                                    control is TabControl || control is InertButton)
                                {
                                    ...
                                    NativeMethods.SendMessage(control.Handle, NativeMethods.WM_LBUTTONDOWN,
                                        ...
                                        NativeMethods.MAKELPARAM(ref temp_wLow, ref temp_wHigh));
