...
#End If
            ...
            Public Class PortableSettingsProvider
                ...
                Public Overrides Sub SetPropertyValues(context As SettingsContext,
                                                       propvals As SettingsPropertyValueCollection)
                ...
                Public Overrides Function GetPropertyValues(context As SettingsContext,
                                                            props As SettingsPropertyCollection) _
                ...
                Private ReadOnly Property SettingsXML As XmlDocument
                    Get
                        ...
                        If m_SettingsXML Is Nothing Then
                            ...
                            Catch ex As Exception
                                'Create new document
                                Dim dec As XmlDeclaration = m_SettingsXML.CreateXmlDeclaration("1.0", "utf-8",
                                                                                               String.Empty)
                ...
                Private Function GetValue(setting As SettingsProperty) As String
                    ...
                    Try
                        ...
                        Else
                            ret =
                                SettingsXML.SelectSingleNode(SETTINGSROOT & "/" & My.Computer.Name & "/" & setting.Name) _
                                    .InnerText
                        End If
                ...
                Private Sub SetValue(propVal As SettingsPropertyValue)
                    ...
                    Try
                        If IsRoaming(propVal.Property) Then
                            SettingNode = DirectCast(SettingsXML.SelectSingleNode(SETTINGSROOT & "/" & propVal.Name),
                                                     XmlElement)
                        Else
                            SettingNode =
                                DirectCast(
                                    SettingsXML.SelectSingleNode(
                                        SETTINGSROOT & "/" & My.Computer.Name & "/" & propVal.Name),
                                    XmlElement)
                        End If
                    Catch ex As Exception
                        SettingNode = Nothing
                    ...
                    Else
                        ...
                        Else
                            ...
                            Try
                                MachineNode =
                                    DirectCast(SettingsXML.SelectSingleNode(SETTINGSROOT & "/" & My.Computer.Name),
                                               XmlElement)
                            Catch ex As Exception
