...
namespace mRemoteNG.Config.Serializers
{
    ...
    public class XmlConnectionNodeSerializer26 : IConnectionSerializer<XElement>
    {
        ...
        private void SetElementAttributes(XContainer element, ConnectionInfo connectionInfo)
        {
            ...
            element.Add(new XAttribute("RedirectAudioInput", connectionInfo.RedirectAudioInput.ToString()));
        ...
        private void SetInheritanceAttributes(XContainer element, IInheritable connectionInfo)
        {
            if (_saveFilter.SaveInheritance)
            {
                ...
                element.Add(new XAttribute("InheritRedirectAudioInput", connectionInfo.Inheritance.RedirectAudioInput.ToString()));
            ...
            else
            {
                ...
                element.Add(new XAttribute("InheritRedirectAudioInput", false.ToString()));
