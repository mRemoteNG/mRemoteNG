...
namespace mRemoteNG.Config.Serializers
{
    public class DataTableDeserializer : IDeserializer
    {
        ...
        private void PopulateConnectionInfoFromDatarow(DataRow dataRow, ConnectionInfo connectionInfo)
        {
            ...
            connectionInfo.RedirectAudioInput = (ProtocolRDP.RDPAudioInput)Enum.Parse(typeof(ProtocolRDP.RDPAudioInput), (string)dataRow["RedirectAudioInput"]);
            ...
            connectionInfo.Inheritance.RedirectAudioInput = (bool)dataRow["InheritRedirectAudioInput"];
