...
Namespace App
    Public Class SupportedCultures
        ...
        Public Shared Function IsNameSupported(CultureName As String) As Boolean
            Return _Instance.ContainsKey(CultureName)
        End Function

        Public Shared Function IsNativeNameSupported(CultureNativeName As String) As Boolean
            Return _Instance.ContainsValue(CultureNativeName)
        End Function

        Public Shared ReadOnly Property CultureName(CultureNativeName As String) As String
            Get
                ...
                For Index = 0 To _Instance.Count
        ...
        Public Shared ReadOnly Property CultureNativeName(CultureName As String) As String
            Get
