...
namespace mRemoteNG.Connection.Protocol.Http
{
    public class HTTPBase : ProtocolBase
    {
        ...
        public override bool Connect()
        {
            try
            {
                var strHost = Convert.ToString(InterfaceControl.Info.Hostname);
                /* 
        ...
        {
            [LocalizedAttributes.LocalizedDescriptionAttribute("strHttpInternetExplorer")] IE = 1,
            [LocalizedAttributes.LocalizedDescriptionAttribute("strHttpGecko")] Gecko = 2
        }
