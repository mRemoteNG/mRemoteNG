...
/*
        ...
        {
            add { LeaveFullscreenEvent = (LeaveFullscreenEventHandler) Delegate.Combine(LeaveFullscreenEvent, value); }
            remove { LeaveFullscreenEvent = (LeaveFullscreenEventHandler) Delegate.Remove(LeaveFullscreenEvent, value); }
        }
        ...
        {
            [LocalizedAttributes.LocalizedDescriptionAttribute("strRDP256Colors")] Colors256 = 8,
            [LocalizedAttributes.LocalizedDescriptionAttribute("strRDP32768Colors")] Colors15Bit = 15,
            [LocalizedAttributes.LocalizedDescriptionAttribute("strRDP65536Colors")] Colors16Bit = 16,
            [LocalizedAttributes.LocalizedDescriptionAttribute("strRDP16777216Colors")] Colors24Bit = 24,
            [LocalizedAttributes.LocalizedDescriptionAttribute("strRDP4294967296Colors")] Colors32Bit = 32
        }

        public enum RDPSounds
        {
            [LocalizedAttributes.LocalizedDescriptionAttribute("strRDPSoundBringToThisComputer")] BringToThisComputer = 0,
            [LocalizedAttributes.LocalizedDescriptionAttribute("strRDPSoundLeaveAtRemoteComputer")] LeaveAtRemoteComputer = 1,
            [LocalizedAttributes.LocalizedDescriptionAttribute("strRDPSoundDoNotPlay")] DoNotPlay = 2
        }
...
//			[Description("strRDPDisableCursorblinking")]DisableCursorBlinking = 0x40,
        ...
        {
            [LocalizedAttributes.LocalizedDescriptionAttribute("strRDPFitToPanel")] FitToWindow,
            [LocalizedAttributes.LocalizedDescriptionAttribute("strFullscreen")] Fullscreen,
            [LocalizedAttributes.LocalizedDescriptionAttribute("strRDPSmartSize")] SmartSize,
        ...
        {
            [LocalizedAttributes.LocalizedDescriptionAttribute("strAlwaysConnectEvenIfAuthFails")] NoAuth = 0,
            [LocalizedAttributes.LocalizedDescriptionAttribute("strDontConnectWhenAuthFails")] AuthRequired = 1,
            [LocalizedAttributes.LocalizedDescriptionAttribute("strWarnIfAuthFails")] WarnOnFailedAuth = 2
        }

        public enum RDGatewayUsageMethod
        {
            [LocalizedAttributes.LocalizedDescriptionAttribute("strNever")] Never = 0, // TSC_PROXY_MODE_NONE_DIRECT
            [LocalizedAttributes.LocalizedDescriptionAttribute("strAlways")] Always = 1, // TSC_PROXY_MODE_DIRECT
            [LocalizedAttributes.LocalizedDescriptionAttribute("strDetect")] Detect = 2 // TSC_PROXY_MODE_DETECT
        }

        public enum RDGatewayUseConnectionCredentials
        {
            [LocalizedAttributes.LocalizedDescriptionAttribute("strUseDifferentUsernameAndPassword")] No = 0,
            [LocalizedAttributes.LocalizedDescriptionAttribute("strUseSameUsernameAndPassword")] Yes = 1,
            [LocalizedAttributes.LocalizedDescriptionAttribute("strUseSmartCard")] SmartCard = 2
        }
