...
namespace mRemoteNG.Connection.Protocol.ICA
{
    public class ProtocolICA : ProtocolBase
    {
        ...
        public ProtocolICA()
        {
            ...
            catch (Exception ex)
            {
                Runtime.MessageCollector.AddMessage(MessageClass.ErrorMsg,
                    Language.strIcaControlFailed + Environment.NewLine + ex.Message, true);
            }
        }
        ...
        public override bool Initialize()
        {
            ...
            {
                Runtime.MessageCollector.AddMessage(MessageClass.ErrorMsg,
                    Language.strIcaSetPropsFailed + Environment.NewLine + ex.Message, true);
                return false;
            }
        }
        ...
        private void SetCredentials()
        {
            try
            {
                ...
                var _user = _Info.Username;
                var _pass = _Info.Password;
                var _dom = _Info.Domain;
            ...
            {
                Runtime.MessageCollector.AddMessage(MessageClass.ErrorMsg,
                    Language.strIcaSetCredentialsFailed + Environment.NewLine + ex.Message, true);
            }
        }
        ...
        private void SetResolution()
        {
            try
            {
                ...
                {
                    _ICAClient.SetWindowSize(ICAWindowType.WindowTypeClient,
                        Screen.FromControl(frmMain.Default).Bounds.Width,
                        Screen.FromControl(frmMain.Default).Bounds.Height, 0);
                ...
                {
                    _ICAClient.SetWindowSize(ICAWindowType.WindowTypeClient, InterfaceControl.Size.Width,
                ...
                else
                {
                    ...
                    _ICAClient.SetWindowSize(ICAWindowType.WindowTypeClient, resolution.Width, resolution.Height, 0);
                }
            }
            catch (Exception ex)
            {
                Runtime.MessageCollector.AddMessage(MessageClass.ErrorMsg,
                    Language.strIcaSetResolutionFailed + Environment.NewLine + ex.Message, true);
            }
        }
        ...
        private void SetEventHandlers()
        {
            ...
            {
                Runtime.MessageCollector.AddMessage(MessageClass.ErrorMsg,
                    Language.strIcaSetEventHandlersFailed + Environment.NewLine + ex.Message, true);
            }
        }
        ...
        {
            [LocalizedAttributes.LocalizedDescriptionAttribute("strEncBasic")] EncrBasic = 1,
            [LocalizedAttributes.LocalizedDescriptionAttribute("strEnc128BitLogonOnly")] Encr128BitLogonOnly = 127,
            [LocalizedAttributes.LocalizedDescriptionAttribute("strEnc40Bit")] Encr40Bit = 40,
            [LocalizedAttributes.LocalizedDescriptionAttribute("strEnc56Bit")] Encr56Bit = 56,
            [LocalizedAttributes.LocalizedDescriptionAttribute("strEnc128Bit")] Encr128Bit = 128
        }
