...
{
	public class ConnectionRecordInheritanceImp : ConnectionRecordInheritanceController
	{
        ...
        #region Constructors
		public ConnectionRecordInheritanceImp(object parent, bool inheritEverything = false)
		{
			this.Parent = parent;
		...
		public object Clone()
		{
			return (ConnectionRecordInheritanceImp)this.MemberwiseClone();
		}
