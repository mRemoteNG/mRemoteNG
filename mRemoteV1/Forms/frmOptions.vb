...
#Region "Private Methods"
    Private Sub LoadOptions()
        ...
        Catch ex As Exception
            MessageCollector.AddMessage(MessageClass.ErrorMsg, "LoadOptions (UI.Window.Options) failed" & vbNewLine & ex.Message, True)
        End Try
    End Sub
    ...
    Private Sub SaveOptions()
        Try
            ...
            Startup.DestroySQLUpdateHandlerAndStopTimer()
            ...
            End If
        Catch ex As Exception
            MessageCollector.AddMessage(MessageClass.ErrorMsg, "SaveOptions (UI.Window.Options) failed" & vbNewLine & ex.Message, True)
        End Try
    End Sub
#End Region
