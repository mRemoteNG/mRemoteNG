...
//									}
		...
		public void frmMain_FormClosing(object sender, System.Windows.Forms.FormClosingEventArgs e)
		{
            if (!(Runtime.WindowList == null || Runtime.WindowList.Count == 0))
			{
				...
				{
					DialogResult result = cTaskDialog.MessageBox(this, (new Microsoft.VisualBasic.ApplicationServices.WindowsFormsApplicationBase()).Info.ProductName, My.Language.strConfirmExitMainInstruction, "", "", "", My.Language.strCheckboxDoNotShowThisMessageAgain, eTaskDialogButtons.YesNo, eSysIcons.Question, eSysIcons.Question);
		...
		protected override void WndProc(ref Message m)
		{
			try
			{
                ...
                else if (m.Msg == Native.WM_ACTIVATEAPP)
				{
		...
		private void UpdateWindowTitle()
		{
			...
			StringBuilder titleBuilder = new StringBuilder(System.Convert.ToInt32(Application.ProductName));
